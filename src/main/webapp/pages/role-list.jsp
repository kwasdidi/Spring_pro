...
<link rel="stylesheet"
	...
	<script type="application/x-javascript">
		 function delrole(Rloeid){
			 const flag = confirm("您确定删除吗？");
			 if(flag){

				 window.location.href ="${pageContext.request.contextPath}/role/del_role?Roleid="+Rloeid;
                                     ...
                                     <c:forEach items="${rolelist}" var="Role">
										 <tr>
											 ...
											 <td class="text-center" id="msg">
												 <a href="#" class="btn bg-olive btn-xs" onclick=delrole(${Role.id})  id="delbtn">删除</a>
												 <span id="span#"></span>
											 </td>
										 </tr>
									 </c:forEach>
